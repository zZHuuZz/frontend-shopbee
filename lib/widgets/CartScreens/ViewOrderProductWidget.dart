...
class ViewOrderProductWidget extends StatefulWidget {
  final Map<String, dynamic> orderProduct;
  const ViewOrderProductWidget({super.key, required this.orderProduct});

  @override
  State<ViewOrderProductWidget> createState() => _ViewOrderProductWidgetState();
}

class _ViewOrderProductWidgetState extends State<ViewOrderProductWidget> {
  @override
